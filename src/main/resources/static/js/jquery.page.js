    ...
    return this.each(function () {
      ...
      if(pageNum == 1){
          ...
          if (l < n+1) {
              ...
              if(pageNum == 3){
                  str += '<li><a href="javascript:">' + (pageNum-2) + '</a></li>';
                  str += '<li><a href="javascript:">' + (pageNum-1) + '</a></li>';
                  str += '<li><a href="javascript:" class="'+active+'">' + pageNum + '</a></li>';
                  str += '<li><a href="javascript:">' + (pageNum+1) + '</a></li>';
                  str += '<li><a href="javascript:">' + (pageNum+2) + '</a></li>';
                  str += '<li><a href="javascript:">' + (pageNum+3) + '</a></li>';
                  str += '<li><a href="javascript:">' + (pageNum+4) + '</a></li>';
              }else if(pageNum == 2){
                  str += '<li><a href="javascript:">' + (pageNum-1) + '</a></li>';
                  str += '<li><a href="javascript:" class="'+active+'">' + pageNum + '</a></li>';
                  str += '<li><a href="javascript:">' + (pageNum+1) + '</a></li>';
                  ...
                  str += '<li><a href="javascript:">' + (pageNum+3) + '</a></li>';
                  str += '<li><a href="javascript:">' + (pageNum+4) + '</a></li>';
                  str += '<li><a href="javascript:">' + (pageNum+5) + '</a></li>';
              }else if(pageNum == 1){
                  str += '<li><a href="javascript:" class="'+active+'">' + pageNum + '</a></li>';
                  str += '<li><a href="javascript:">' + (pageNum+1) + '</a></li>';
                  str += '<li><a href="javascript:">' + (pageNum+2) + '</a></li>';
                  ...
                  str += '<li><a href="javascript:">' + (pageNum+4) + '</a></li>';
                  str += '<li><a href="javascript:">' + (pageNum+5) + '</a></li>';
                  str += '<li><a href="javascript:">' + (pageNum+6) + '</a></li>';
              }else if(pageNum == l){
                  str += '<li><a href="javascript:">' + (pageNum-6) + '</a></li>';
                  str += '<li><a href="javascript:">' + (pageNum-5) + '</a></li>';
                  str += '<li><a href="javascript:">' + (pageNum-4) + '</a></li>';
      ...
      /*if(pageNum != 1){
        var nums = odevity(n);
        if(pageNum > l-nums/2&&pageNum < l+1){
            //最后几项
            fpageNext((n-1)-(l-pageNum));
            console.log
        }else if(pageNum > 0&&pageNum < nums/2){
            //最前几项
            fpagePrv(pageNum-1);
        }else{
            fpageShow(pageNum);
